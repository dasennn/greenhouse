...
MATERIAL_DEFAULTS = [
    ...
    ("cultivation_pipe_left", "Σωλήνας Καλλιέργειας (Αριστερά - Πάτημα/Στένεμα)", "piece", 8.00, "1\"", "-", "5m"),  # πάτημα-στένεμα
    ("cultivation_pipe_middle", "Σωλήνας Καλλιέργειας (Μέση - Στένεμα/Ανοιχτό)", "piece", 8.00, "1\"", "-", "5m"),  # στένεμα-ανοιχτό
    ("cultivation_pipe_right", "Σωλήνας Καλλιέργειας (Δεξιά - Πάτημα/Ανοιχτό)", "piece", 8.00, "1\"", "-", "5m"),  # πάτημα-ανοιχτό
]
